...
if __name__ == '__main__':
    ...
    leaf_dir = os.path.join(args.dataset, args.noise_type+'_'+args.noisy_ratio,args.class_method,'epoch_{eph}_alpha_{alpha}_seed_{seed}'.format(eph=args.total_epochs, alpha=args.alpha, seed=args.seed))
