...
class Cycle_Weight(INIT):
    ...
    def update_model_cycle_reweight(self):
        ...
        for index, images, classes, labels in self.trainloader:
            ...
            loss = self.loss_func_reweight(outputs, self.transition.clone().detach(), labels)
    ...
    def run(self):
        ...
        for epoch in range(self.args.total_epochs):
            epoch_loss, epoch_class_acc, epoch_label_acc, time_train = self.update_model_cycle_reweight()
