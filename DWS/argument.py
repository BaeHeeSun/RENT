...
parser.add_argument('--N', type=int, default=1, help='how much samples to choose?// SIR')

parser.add_argument('--alpha',type=float,default=None,help='dirichlet parameter')

# etc
parser.add_argument('--set_gpu', type=str, default='0', help='gpu setting')
parser.add_argument('--data_dir', type=str, default='/home/aailab/baeheesun96/noise_generalization/data/')
